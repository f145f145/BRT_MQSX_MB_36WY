        ...
        private void SaveAIOChannels()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                try
                {
                    ...
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD1.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD1.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD1.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD1.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD1.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD1.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD1.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD1.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD1.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD1.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD2.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD2.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD2.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD2.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD2.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD2.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD2.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD2.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD2.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD2.Channels[i].FitRatio;
                        C06TableAdapter.Update(C06Table);
                        C06Table.AcceptChanges();
                    }
                }
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD3.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD3.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD3.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD3.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD3.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD3.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD3.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD3.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD3.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD3.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD4.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD4.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD4.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD4.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD4.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD4.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD4.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD4.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD4.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD4.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD8.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD8.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD8.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD8.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD8.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD8.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD8.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD8.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD8.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD8.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD9.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD9.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD9.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD9.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD9.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD9.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD9.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD9.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD9.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD9.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD5.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD5.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD5.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD5.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD5.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD5.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD5.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD5.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD5.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD5.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD6.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD6.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD6.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD6.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD6.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD6.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD6.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD6.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD6.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD6.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (devC06chlRow != null)
                    {
                        devC06chlRow.ChannelNO = DAL_Dev.Mod_AD7.Channels[i].ChannelNO;
                        devC06chlRow.ColType = DAL_Dev.Mod_AD7.Channels[i].InfType;
                        devC06chlRow.ElecSig_Unit = DAL_Dev.Mod_AD7.Channels[i].ElecSigUnit;
                        devC06chlRow.ElecSig_LowerRange = DAL_Dev.Mod_AD7.Channels[i].ElecSigLowerRange;
                        devC06chlRow.ElecSig_UpperRange = DAL_Dev.Mod_AD7.Channels[i].ElecSigUpperRange;
                        devC06chlRow.Data_LowerRange = DAL_Dev.Mod_AD7.Channels[i].DataLowerRange;
                        devC06chlRow.Data_UpperRange = DAL_Dev.Mod_AD7.Channels[i].DataUpperRange;
                        devC06chlRow.IsUsed = DAL_Dev.Mod_AD7.Channels[i].IsUsed;
                        devC06chlRow.IsOutType = DAL_Dev.Mod_AD7.Channels[i].IsOutType;
                        devC06chlRow.FitRitio = DAL_Dev.Mod_AD7.Channels[i].FitRatio;
                    }
                }
                catch (Exception ex)
                {
