        ...
        private void SMWDDJStageFunc()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < stepsCount; i++)
                {
                    ...
                    if ((BllDev.IsWithCYM) && (tempAim < Math.Abs(BllDev.AIList[1].SingalUpperRange) * 0.9))
                        tempValueNow = Math.Abs(BllDev.AIList[1].ValueFinal);
                    else
                        tempValueNow = Math.Abs(BllDev.AIList[2].ValueFinal);
        ...
        private void SMBDDJStageFunc()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < stepsCount; i++)
                {
                    ...
                    //当前压力
                    if (BllDev.IsWithCYM)
                        tempValueNow = BllDev.AIList[1].ValueFinal;
                    else
                        tempValueNow = BllDev.AIList[2].ValueFinal;
