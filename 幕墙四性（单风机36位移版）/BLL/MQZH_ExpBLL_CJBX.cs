                    ...
                    if (!BllExp.Exp_CJBX.ExpXM_CJBXStage_DQ.StepList[i].IsStepCompleted)
                    {
                        ...
                        if (!IsStepOrderSend)
                        {
                            ...
                            if (Math.Abs(BllDev.WYValueX - aimPositionX) > Math.Abs(BllDev.PermitErrX))
                            {
                                ...
                                double dataTrans = BllDev.AIList[BllDev.WYNOList[0] +13].GetTransDataFromValueFinal_AI(-aimPositionX);       //X对应传输值
                                if (dataTrans > 4000)
                                    dataTrans = 4000;
                                if (dataTrans < 0)
                                    dataTrans = 0;
                    ...
                    if (!BllExp.Exp_CJBX.ExpXM_CJBXStage_DQ.StepList[i].IsStepCompleted)
                    {
                        ...
                        if (!IsStepOrderSend)
                        {
                            ...
                            if (Math.Abs(BllDev.WYValueY[3] - aimPositionY) > Math.Abs(BllDev.PermitErrY))
                            {
                                ...
                                double dataTrans1 = BllDev.AIList[BllDev.WYNOList[1] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //左点对应传输值
                                double dataTrans2 = BllDev.AIList[BllDev.WYNOList[2] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //中间点对应传输值
                                double dataTrans3 = BllDev.AIList[BllDev.WYNOList[3] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //右点对应传输值
                    ...
                    if (!BllExp.Exp_CJBX.ExpXM_CJBXStage_DQ.StepList[i].IsStepCompleted)
                    {
                        ...
                        if (!IsStepOrderSend)
                        {
                            ...
                            if (Math.Abs(BllDev.WYValueZ[3] - BllExp.Exp_CJBX.ExpXM_CJBXStage_DQ.StepList[i].AimPosition) > Math.Abs(BllDev.PermitErrZ))
                            {
                                ...
                                double dataTrans1 = BllDev.AIList[BllDev.WYNOList[4] + 13].GetTransDataFromValueFinal_AI(aimPositionZ);       //左点对应传输值
                                double dataTrans2 = BllDev.AIList[BllDev.WYNOList[5] + 13].GetTransDataFromValueFinal_AI(aimPositionZ);       //中间点对应传输值
                                double dataTrans3 = BllDev.AIList[BllDev.WYNOList[6] + 13].GetTransDataFromValueFinal_AI(aimPositionZ);       //右点对应传输值
                                double dataTransAverage = (dataTrans1 + dataTrans2 + dataTrans3) / 3;
                                if (dataTransAverage > 4000)
                                    dataTransAverage = 4000;
                                if (dataTransAverage < 0)
                    ...
                    if (!BllExp.Exp_CJBX.ExpXM_CJBXStage_DQ.StepList[i].IsStepCompleted)
                    {
                        ...
                        if (!IsStepOrderSend)
                        {
                            ...
                            if (Math.Abs(BllDev.WYValueX - aimPositionX) > Math.Abs(BllDev.PermitErrX))
                            {
                                ...
                                BllDev.Tips = "Mode:" + OnceOrderValuesFrmBLL[0].ToString() + ";Dmode:" + OnceOrderValuesFrmBLL[1].ToString() + ";Dir:" + OnceOrderValuesFrmBLL[13].ToString() + "\r\n"
                                    + "Aim:" + OnceOrderValuesFrmBLL[14].ToString() + ";No:" + OnceOrderValuesFrmBLL[17].ToString();
