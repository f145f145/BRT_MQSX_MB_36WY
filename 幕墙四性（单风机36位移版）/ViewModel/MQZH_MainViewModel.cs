...
namespace MQZHWL.ViewModel
{
    public partial class MQZH_MainViewModel : ViewModelBase
    {
        ...
        private void ExecuteDevSetCMD(String num)
        {
            ...
            {
                Messenger.Default.Send<string>("WY13", "SetZeroMessage");
            }
            else if (i == 8573)
            {
                Messenger.Default.Send<string>("WY14", "SetZeroMessage");
            }
            else if (i == 8574)
            {
                Messenger.Default.Send<string>("WY15", "SetZeroMessage");
            }
            else if (i == 8575)
            {
                Messenger.Default.Send<string>("WY16", "SetZeroMessage");
            }
            else if (i == 8576)
            {
                Messenger.Default.Send<string>("WY17", "SetZeroMessage");
            }
            else if (i == 8577)
            {
                Messenger.Default.Send<string>("WY18", "SetZeroMessage");
            }
            else if (i == 8578)
            {
                Messenger.Default.Send<string>("WY19", "SetZeroMessage");
            }
            else if (i == 8579)
            {
                Messenger.Default.Send<string>("WY20", "SetZeroMessage");
            }
            else if (i == 8580)
            {
                Messenger.Default.Send<string>("WY21", "SetZeroMessage");
            }
            else if (i == 8581)
            {
                Messenger.Default.Send<string>("WY22", "SetZeroMessage");
            }
            else if (i == 8582)
            {
                Messenger.Default.Send<string>("WY23", "SetZeroMessage");
            }
            else if (i == 8583)
            {
                Messenger.Default.Send<string>("WY24", "SetZeroMessage");
            }
            else if (i == 8584)
            {
                Messenger.Default.Send<string>("WY25", "SetZeroMessage");
            }
            else if (i == 8585)
            {
                Messenger.Default.Send<string>("WY26", "SetZeroMessage");
            }
            else if (i == 8586)
            {
                Messenger.Default.Send<string>("WY27", "SetZeroMessage");
            }
            else if (i == 8587)
            {
                Messenger.Default.Send<string>("WY28", "SetZeroMessage");
            }
            else if (i == 8588)
            {
                Messenger.Default.Send<string>("WY29", "SetZeroMessage");
            }
            else if (i == 8589)
            {
                Messenger.Default.Send<string>("WY30", "SetZeroMessage");
            }
            else if (i == 8590)
            {
                Messenger.Default.Send<string>("WY31", "SetZeroMessage");
            }
            else if (i == 8591)
            {
                Messenger.Default.Send<string>("WY32", "SetZeroMessage");
            }
            else if (i == 8592)
            {
                Messenger.Default.Send<string>("WY33", "SetZeroMessage");
            }
            else if (i == 8593)
            {
                Messenger.Default.Send<string>("WY43", "SetZeroMessage");
            }
            else if (i == 8594)
            {
                Messenger.Default.Send<string>("WY35", "SetZeroMessage");
            }
            else if (i == 8595)
            {
                Messenger.Default.Send<string>("WY36", "SetZeroMessage");
            }
            else if (i == 8596)
            {
                Messenger.Default.Send<string>("GW", "SetZeroMessage");
            }
            else if (i == 8597)
            {
                Messenger.Default.Send<string>("GS", "SetZeroMessage");
            }
            #region 管理员登录
        ...
        /// X轴移动距离（mm）
        /// </summary>
        private double _ydjl_X = 0;
        /// <summary>
        /// X轴移动距离（mm）
        /// </summary>
        public double YDJL_X
        {
            get { return _ydjl_X; }
            set
            {
        ...
        /// Y轴移动距离（mm）
        /// </summary>
        private double _ydjl_Y = 0;
        /// <summary>
        /// Y轴移动距离（mm）
        /// </summary>
        public double YDJL_Y
        {
            get { return _ydjl_Y; }
            set
            {
        ...
        /// Z轴移动距离（mm）
        /// </summary>
        private double _ydjl_Z = 0;
        /// <summary>
        /// Z轴移动距离（mm）
        /// </summary>
        public double YDJL_Z
        {
            get { return _ydjl_Z; }
            set
            {
        ...
        private void ExecuteSDWYCommand(String num)
        {
            ...
            else if (i == 6516)
            {
                ...
                double dataTrans = Dev.AIList[Dev.WYNOList[0] + 13].GetTransDataFromValueFinal_AI(-aimPositionX);       //X轴位移尺对应传输值
            ...
            else if (i == 6517)
            {
                ...
                double dataTrans1 = Dev.AIList[Dev.WYNOList[1] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //左点对应传输值
                double dataTrans2 = Dev.AIList[Dev.WYNOList[2] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //中间点对应传输值
                double dataTrans3 = Dev.AIList[Dev.WYNOList[3] + 13].GetTransDataFromValueFinal_AI(-aimPositionY);       //右点对应传输值
            ...
            else if (i == 6518)
            {
                ...
                double dataTrans1 = Dev.AIList[Dev.WYNOList[4] + 131].GetTransDataFromValueFinal_AI(aimPositionZ);       //左点对应传输值
                double dataTrans2 = Dev.AIList[Dev.WYNOList[5] + 13].GetTransDataFromValueFinal_AI(aimPositionZ);       //中间点对应传输值
                double dataTrans3 = Dev.AIList[Dev.WYNOList[6] + 13].GetTransDataFromValueFinal_AI(aimPositionZ);       //右点对应传输值
                double dataTransAverage = (dataTrans1 + dataTrans2 + dataTrans3) / 3;
                if (dataTransAverage > 4000)
                    dataTransAverage = 4000;
                if (dataTransAverage < 0)
        ...
        private void UpdatePlotLins()
        {
            ...
            newPoint0.Y = Dev.AIList[0].ValueFinal;
            ...
            if (Dev.IsWithCYM)
            {
                ...
                newPoint1.Y = Dev.AIList[1].ValueFinal;
            ...
            newPoint2.Y = Dev.AIList[2].ValueFinal;
            ...
            newPoint23.Y = Dev.AIList[10].ValueFinal;
            ...
            if (Dev.IsWithSLL)
            {
                ...
                newPoint24.Y = Dev.AIList[11].ValueFinal;
                    ...
                    else
                    {
                        for (int i = 0; i < ExpDQ.Exp_KFY.DisplaceGroups.Count; i++)
                        {
                            if (ExpDQ.Exp_KFY.DisplaceGroups[i].Is_Use)
                            {
                                ...
                                {
                                    int k = ExpDQ.Exp_KFY.DisplaceGroups[i].WYC_No[j];
                                    ExpDQ.Exp_KFY.DisplaceGroups[i].WY_DQ[j] = Dev.AIList[k +13].ValueFinal;
                                    if (j == 3)
                                    {
                                        if ((i == 0) && ExpDQ.Exp_KFY.DisplaceGroups[0].Is_Use && ExpDQ.Exp_KFY.DisplaceGroups[0].Is_TestMBBX && ExpDQ.Exp_KFY.DisplaceGroups[0].IsBZCSJMB)
                                            ExpDQ.Exp_KFY.DisplaceGroups[i].WY_DQ[j] = Dev.AIList[k +13].ValueFinal;
