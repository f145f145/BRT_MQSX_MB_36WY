        ...
        public void StatusUpdate(ushort[] msg)
        {
            try
            {
                ...
                if (inArry.Length >= 13)
                {
                    ...
                    FFMode = MQZH_ValueCvtBLL.GetShortFromUshort(msg,0);
                    TimesZYWave = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 1);
                    TimesFYWave = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 2);
                    ErrType = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 3);
                    SelfTestStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 4);
                    ManualStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 5);
                    PLowPrepareStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 6);
                    NLowPrepareStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 7);
                    PWaveStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 8);
                    NWaveStatus = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 9);
                    ActType = MQZH_ValueCvtBLL.GetShortFromUshort(msg, 10);
                }
